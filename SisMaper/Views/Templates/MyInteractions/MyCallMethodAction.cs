...
namespace SisMaper.Views.Templates.MyInteractions
{
    ...
    public class MyCallMethodAction : TriggerAction<DependencyObject>
    {
        ...
        public static readonly DependencyProperty TargetObjectProperty = DependencyProperty.Register("TargetObject", typeof(object), typeof(MyCallMethodAction), new PropertyMetadata(OnTargetObjectChanged));
        public static readonly DependencyProperty MethodNameProperty = DependencyProperty.Register("MethodName", typeof(string), typeof(MyCallMethodAction), new PropertyMetadata(OnMethodNameChanged));
        ...
        private void UpdateMethodInfo()
        {
            ...
            if (this.Target != null && !string.IsNullOrEmpty(this.MethodName))
            {
                ...
                for (int i = 0; i < methods.Length; i++)
                {
                    ...
                    if (!MyCallMethodAction.AreMethodParamsValid(methodParams))
                    {
                        continue;
                    }
